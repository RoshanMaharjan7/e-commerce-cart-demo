...
const TopRatingCard = ({productId,productTitle, productPrice, productCategory, productColor, productImg, productRatings}:products) => {

  const dispatch = useDispatch()
  return (
    <div key={productId} className='flex items-center gap-8 w-[380px] h-[308px] relative'>
        <Image src={productImg} width={198} height={308} alt={productTitle}/>
        <div className='w-[120px] h-[129px] flex flex-col gap-4'>
        ...
        <span className='absolute w-[198px] h-full top-0 left-0 cursor-pointer flex opacity-0 hover:opacity-100 justify-center items-center'>
